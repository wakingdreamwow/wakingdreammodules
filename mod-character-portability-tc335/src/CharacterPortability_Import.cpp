...
namespace WCPX
{
                    ...
                    std::string const& sourceContact)
    {
        ...
        if (cfg.TrustMode == "tofu")
        {
            ...
            TC_LOG_WARN("module", "[WCPX] tofu-pending import from '{}' pubkey {}; admin must approve",
                     sourceName, pubB64);
        }
        return false;
    }
                          ...
                          std::string& errorOut)
    {
        ...
        TC_LOG_INFO("module", "[WCPX] import: spells inserted={} skipped={}",
        ...
        TC_LOG_INFO("module", "[WCPX] import: achievements inserted={}", achievementsInserted);
        ...
        TC_LOG_INFO("module", "[WCPX] import: talents inserted={}", talentsInserted);
        ...
        if (cfg.ImportAcceptEquipment)
        {
            ...
            TC_LOG_INFO("module", "[WCPX] import: equipment inserted={} skipped={}",
    ...
    ImportResult DoImport(ImportRequest const& req)
    {
        ...
        TC_LOG_INFO("module", "[WCPX] imported char '{}' as guid={} from source '{}'",
